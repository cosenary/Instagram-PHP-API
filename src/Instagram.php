...
class Instagram
{
    ...
    /**
     * Rate limit when known, null otherwise.
     *
     * @var int|null
     */
    private $_xRateLimitRemaining = null;
     ...
     *
     * @return int|null X-RateLimit-Remaining API calls left within 1 hour or null if unknown.
     */
