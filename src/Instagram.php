...
class Instagram {
    ...
    protected function _makeCall($function, $auth = false, $params = null, $method = 'GET') {
        ...
        $sig = $this->generateSig('/'.$function, array_merge(array('access_token'=>$this->getAccessToken()),$params));
        
        $params  = array_merge(array('sig' => $sig), $params);
     ...
     *
     * @return string                       The signed params
     */
